...
#elif (CONFIG_STM32_HSE_HZ == 12000000)
#define RCC_CFGR_PLLMUL_CFG	0x4
struct psc psc_hse = {
	.ahb_psc = AHB_PSC_1,
	.apb1_psc = APB_PSC_2,
	.apb2_psc = APB_PSC_1
...
int configure_clocks(void)
{
	...
	/* FIXME: check these NOW!!! */
	setbits_le32(&STM32_RCC->apb1enr, RCC_APB1ENR_PWREN);
	writel(PWR_CR_VOS_SCALE_MODE_1, &STM32_PWR->cr);

	setbits_le32(&STM32_RCC->cfgr, RCC_CFGR_PLLMUL_CFG << RCC_CFGR_PLLMUL_SHIFT);
