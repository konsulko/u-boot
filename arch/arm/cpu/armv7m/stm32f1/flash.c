...
static struct stm32_flash_bank_regs *flash_bank[CONFIG_SYS_MAX_FLASH_BANKS];
...
unsigned long flash_init(void)
{
	...
	/* Set up per-bank pointers for XL devices */
...
void flash_print_info(flash_info_t *info)
{
	...
	printf("  Size: %ld MB in %d Sectors\n",
	       info->size >> 19, info->sector_count);
